...
SWIFT_CLASS("_TtC10MetalScope23MonoSphericalVideoScene")
@interface MonoSphericalVideoScene : MonoSphericalMediaScene
...
- (void)setNeedsResetRotation:(id _Nullable)sender;
@end
...
SWIFT_CLASS("_TtC10MetalScope25StereoSphericalVideoScene")
@interface StereoSphericalVideoScene : StereoSphericalMediaScene
@property (nonatomic, getter=isPaused) BOOL paused;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
